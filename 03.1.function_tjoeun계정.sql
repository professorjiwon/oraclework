...
SELECT TO_DATE('901021', 'YY/MM/DD') FROM DUAL;
SELECT TO_CHAR(TO_DATE('99/10/21', 'YY/MM/DD')) FROM DUAL;      -- 현재 세기로 반영
SELECT TO_CHAR(TO_DATE('90/10/21', 'YY/MM/DD'), 'YYYY/MM/DD') FROM DUAL;
